        ...
        >
          ...
          <div className="flex border-b-4 border-black bg-yellow-100 p-2 gap-2 print:hidden">
            <button
              ...
              className={`flex-1 py-4 px-4 rounded-2xl font-black text-base sm:text-lg uppercase tracking-wider flex items-center justify-center gap-2 border-2 border-black transition-all cursor-pointer ${
            ...
            {activeTab === 'certificate' ? (
              completedCount === 0 ? (
                ...
                <div className="bg-amber-50 border-4 border-black rounded-[32px] p-8 sm:p-12 text-center flex flex-col items-center justify-center gap-4 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] my-2">
                  ...
                  <p className="text-base sm:text-lg font-extrabold text-gray-700 max-w-md leading-relaxed font-sans">
                  ...
                  <div className="flex items-center gap-2 bg-white border-2 border-black px-5 py-2.5 rounded-2xl font-black text-base shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] my-1">
                  ...
                  <button
                    ...
                    className="mt-2 px-8 py-4 bg-emerald-400 hover:bg-emerald-500 text-black border-3 border-black font-black text-base uppercase tracking-wider rounded-2xl shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] flex items-center gap-2 cursor-pointer transition-all hover:scale-105"
                  >
                ...
                <div className="bg-orange-50 border-3 border-black p-5 rounded-2xl flex flex-col sm:flex-row items-center justify-between gap-4 print:hidden shadow-[3px_3px_0px_0px_rgba(0,0,0,1)]">
                  <div className="flex-1 w-full">
                    <label className="block text-sm sm:text-base font-black uppercase text-gray-800 mb-1.5">
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 border-2 border-black rounded-xl font-black text-base bg-white focus:outline-none focus:ring-2 focus:ring-orange-400"
                    />
                  </div>

                  <div>
                    <label className="block text-sm sm:text-base font-black uppercase text-gray-800 mb-1.5 text-center sm:text-left">
                      Choose Buddy:
                    </label>
                    <div className="flex gap-2 flex-wrap">
                      {BUDDIES.map((b) => (
                        <button
                          ...
                          className={`w-11 h-11 rounded-xl border-2 border-black text-2xl flex items-center justify-center transition-all cursor-pointer ${
                ...
                >
                  ...
                  <p className="text-sm sm:text-base font-bold text-gray-600 max-w-md">
                  ...
                  <p className="text-sm sm:text-base font-bold text-gray-700 max-w-lg leading-relaxed mb-6">
                  ...
                  <div className="w-full max-w-md bg-amber-100/60 border-2 border-amber-300 rounded-2xl p-4 my-2 grid grid-cols-2 gap-3 text-left font-sans">
                    <div className="flex items-center gap-2.5">
                      <Star className="w-6 h-6 fill-yellow-400 text-black flex-shrink-0" />
                      <div>
                        <div className="text-xs font-black uppercase text-gray-600">Total Stars</div>
                    ...
                    <div className="flex items-center gap-2.5">
                      ...
                      <div>
                        <div className="text-xs font-black uppercase text-gray-600">Activities</div>
                  ...
                  <div className="w-full max-w-md flex justify-between items-end mt-8 pt-4 border-t-2 border-amber-200 text-left font-sans">
                    <div className="flex flex-col">
                      <span className="font-black text-base italic text-gray-800">Teddy & Friends</span>
                      <span className="text-xs font-black uppercase text-gray-500 border-t border-gray-400 pt-0.5 mt-1">
                        Storybook Mascot
                      </span>
                    </div>
              ...
              <div className="flex flex-col gap-6">
                <div className="text-center">
                  <h3 className="text-2xl font-black uppercase tracking-tight">YOUR LEARNING BADGES GALLERY</h3>
                  <p className="text-sm sm:text-base font-extrabold text-gray-700 mt-1">
                  ...
                  {BADGES.map((badge) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <h4 className="font-black text-sm uppercase leading-tight mt-1">{badge.title}</h4>
                        <span className="text-xs font-black uppercase mt-1 opacity-80">
                          {badge.skill}
                        </span>

                        <div className="mt-3 pt-2 border-t border-black/20 w-full text-xs font-black">
