...
const INITIAL_ITEMS: SorterItem[] = [
  ...
  { id: 'r5', emoji: '🎈', name: 'Red Balloon', color: 'red' },
  // Blue items
  { id: 'b1', emoji: '🫐', name: 'Blueberries', color: 'blue' },
  { id: 'b2', emoji: '🐳', name: 'Whale', color: 'blue' },
  { id: 'b3', emoji: '🐬', name: 'Dolphin', color: 'blue' },
  { id: 'b4', emoji: '🚙', name: 'Blue Car', color: 'blue' },
  { id: 'b5', emoji: '🧢', name: 'Blue Cap', color: 'blue' },
  // Green items
  ...
  { id: 'g5', emoji: '🥑', name: 'Avocado', color: 'green' },
  // Yellow items
  ...
  { id: 'y5', emoji: '🧀', name: 'Cheese', color: 'yellow' },
];
